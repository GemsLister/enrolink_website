...
router.post('/events', auth, requireAnyRole('DEPT_HEAD','OFFICER'), ctrl.create);
router.patch('/events/:id', auth, requireAnyRole('DEPT_HEAD','OFFICER'), ctrl.update);
router.delete('/events/:id', auth, requireAnyRole('DEPT_HEAD','OFFICER'), ctrl.remove);
