...
import StudentFilters from '../head/components/StudentFilters'
import StudentTable from '../head/components/StudentTable'
import StudentDetailsModal from '../head/components/StudentDetailsModal'
import { useStudentRecords } from '../head/hooks/useStudentRecords'
import { useAuth } from '../../hooks/useAuth'
import { useApi } from '../../hooks/useApi'
import ImportModal from '../head/components/ImportModal'
import { toApiStatus } from '../../utils/status'

export default function OfficerStudentRecords() {
      ...
      <div className="flex-1 bg-gray-50 px-8 pt-8 pb-4 overflow-y-auto h-[100dvh]">
        ...
        <StudentTable
          ...
          getStatusBadge={(s)=>{
            ...
            if (s==='Passed') return `${base} bg-green-100 text-green-800`
